  ...
  return (
    <div className="max-w-4xl mx-auto py-8 md:py-16 px-4">
      <div className="text-center mb-12 md:mb-16">
        ...
        <p className="text-lg md:text-xl opacity-80 mb-6 md:mb-8">Level / Game / Technical Design Portfolio</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12 md:mb-16">
        <Link href="/projects/professional" className="group p-4 md:p-6 border rounded-lg hover:shadow-lg transition-shadow">
          <h3 className="font-semibold text-base md:text-lg mb-2 group-hover:text-blue-600">Professional Projects</h3>
        ...
        <Link href="/projects/personal" className="group p-4 md:p-6 border rounded-lg hover:shadow-lg transition-shadow">
          <h3 className="font-semibold text-base md:text-lg mb-2 group-hover:text-blue-600">Personal Projects</h3>
        ...
        <Link href="/projects" className="group p-4 md:p-6 border rounded-lg hover:shadow-lg transition-shadow">
          <h3 className="font-semibold text-base md:text-lg mb-2 group-hover:text-blue-600">All Projects</h3>
        ...
        <Link href="/about" className="group p-4 md:p-6 border rounded-lg hover:shadow-lg transition-shadow">
          <h3 className="font-semibold text-base md:text-lg mb-2 group-hover:text-blue-600">About Me</h3>
          <p className="text-xs md:text-sm opacity-70">My story and expertise</p>
        </Link>
      </div>

      <section>
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8">Featured Projects</h2>
